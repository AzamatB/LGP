...
project = u'LGP'
copyright = u'2017, Azamat Berdyshev'
author = u'Azamat Berdyshev'
...
latex_documents = [
  (master_doc, 'LGP.tex', u'LGP Documentation',
   u'Azamat Berdyshev', 'manual'),
]
...
man_pages = [
    (master_doc, 'lgp', u'LGP Documentation',
     [author], 1)
]
